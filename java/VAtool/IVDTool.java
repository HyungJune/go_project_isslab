...
public class IVDTool {
	...
	private static byte sslHello_origin[] = new byte[] {
		0x16, 0x03, 0x03, 0x00, (byte) 0xe6, // Content type = 16 (handshake message); Version = 03 03; Packet length = 00 dc
		0x01, 0x00, 0x00, (byte) 0xe2, //Message type = 01 (client hello); Length = 00 00 d8
