...
public class IVDTool {
	...
	private static byte sslHello_origin[] = new byte[] {
		0x16, 0x03, 0x03, 0x00, (byte) 0xe4, // Content type = 16 (handshake message); Version = 03 03; Packet length = 00 dc
		0x01, 0x00, 0x00, (byte) 0xe0, //Message type = 01 (client hello); Length = 00 00 d8
		...
		0x00, 0x06, 
		0x00, 0x03, 
		0x00, (byte) 0xff, //102 cipher suites //51¡Æ©ø
		
		0x01, //Compression methods length
		0x00, //Compression method 0 : no compression = 0
		0x00, 0x4f, //Extension length = 79
